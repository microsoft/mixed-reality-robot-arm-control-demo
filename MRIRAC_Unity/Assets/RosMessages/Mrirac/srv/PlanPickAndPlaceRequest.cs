...
{
    [Serializable]
    public class PlanPickAndPlaceRequest : Message
    {
        ...
        public PlanPickAndPlaceRequest()
        {
        ...
        public PlanPickAndPlaceRequest(Geometry.PoseMsg pre_grasp_pose, Geometry.PoseMsg grasp_pose, Geometry.PoseMsg pre_place_pose, Geometry.PoseMsg place_pose)
        {
        ...
        public static PlanPickAndPlaceRequest Deserialize(MessageDeserializer deserializer) => new PlanPickAndPlaceRequest(deserializer);

        private PlanPickAndPlaceRequest(MessageDeserializer deserializer)
        {
        ...
        {
            return "PlanPickAndPlaceRequest: " +
